...
class _OutingListPageState extends State<OutingListPage> {
                        ...
                        children: [
                          Expanded(
                            child: GestureDetector(
                              ...
                              child: filterButton("All", selectedFilter == 0),
                            ),
                          ),
  ...
  Widget filterButton(String text, bool selected) {
    return Container(
      height: 46,
      alignment: Alignment.center,
      decoration: BoxDecoration(
        color: selected ? Colors.lightBlue : Colors.white12,
        borderRadius: BorderRadius.circular(14),
      ),
      child: Text(
        text,
